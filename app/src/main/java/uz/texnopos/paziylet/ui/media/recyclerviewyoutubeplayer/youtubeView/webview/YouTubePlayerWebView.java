 ...
 */
package uz.texnopos.paziylet.ui.media.recyclerviewyoutubeplayer.youtubeView.webview;
...
import uz.texnopos.paziylet.BuildConfig;
...
public class YouTubePlayerWebView extends WebView {
    ...
    public void initialize(@NonNull String webViewUrl) {
        $Precondition$Check.INSTANCE.checkArgument(!TextUtils.isEmpty(webViewUrl), "WebView url cannot be empty");
        if (!isPlayerReady) {
